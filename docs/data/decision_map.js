...
(function () {
  var NODES = [
    ...
    { id: 'pred_tense', parent: 'pred', title: '时态', sub: '找时间标志和上下文' },
    ...
    { id: 'pred_voice', parent: 'pred', title: '语态', sub: '主语是否承受动作？' },
    ...
    { id: 'pred_sva', parent: 'pred', title: '主谓一致', sub: '回到主语中心词' },
    ...
    { id: 'adj', parent: 'word', title: '形容词', sub: '修饰名词 / 作表语', cat: 'word' },
    ...
    { id: 'adv', parent: 'word', title: '副词', sub: '修饰动作 / 形容词 / 句子', cat: 'word' },
    ...
    { id: 'cmp', parent: 'word', title: '比较级 / 最高级', sub: 'than / much / the most 等信号触发', cat: 'word' },
    ...
    { id: 'coord', parent: 'conj', title: '并列连词', sub: '连接同层词 / 短语 / 句子', cat: 'logic' },
