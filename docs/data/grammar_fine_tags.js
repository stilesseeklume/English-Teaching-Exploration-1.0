...
(function () {
  var DATA = {
    ...
    tags: [
      ...
      // preposition 介词（5）
      { id: 'prep-time',         category: 'preposition', source: '体系重订2026-05-31', name: '时间介词' },
      { id: 'prep-place',        category: 'preposition', source: '体系重订2026-05-31', name: '地点介词' },
      { id: 'prep-manner',       category: 'preposition', source: '体系重订2026-05-31', name: '方式介词' },
      { id: 'prep-reason',       category: 'preposition', source: '体系重订2026-05-31', name: '原因介词' },
      { id: 'prep-collocation',  category: 'preposition', source: '体系重订2026-05-31', name: '固定搭配（动介/形介/名介）' },
      // logic 逻辑连词（2）
      { id: 'logic-coordinating',category: 'logic', source: '体系重订2026-05-31', name: '并列连词（and/but/or/so）' },
      { id: 'logic-correlative', category: 'logic', source: '体系重订2026-05-31', name: '关联连词（both…and/either…or）' },
      // attrib 定语从句（4）
      ...
      { id: 'advc-purpose-result', category: 'advclause', source: '体系重订2026-05-31', name: '目的/结果状语从句' },
      { id: 'advc-manner-place',   category: 'advclause', source: '体系重订2026-05-31', name: '方式/地点状语从句' },
      // modal 情态动词（4）
